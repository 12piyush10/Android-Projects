package com.piyush_pooja.wallpaper;
...
import com.piyush_pooja.wallpaper.Model.WallpaperItem;
import com.piyush_pooja.wallpaper.ViewHolder.ListWallpaperViewHolder;
                            ...
                            public void onError() {
                                ...
                                Picasso.with(getBaseContext())
                                        ...
                                        .into(holder.wallpaper, new Callback() {
                                            ...
                                            @Override
                                            public void onError() {
                                                Log.e("ERROR MSG_Piyush","Could not fetch message");
