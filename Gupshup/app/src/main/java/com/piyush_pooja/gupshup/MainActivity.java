...
public class MainActivity extends AppCompatActivity {
    ...
    static final String APP_ID = "57066";
    static final String AUTH_KEY = "e9Ln2XPWAVx73N7";
    static final String AUTH_SECRET = "MwqufqnxjpANLDf";
    static final String ACCOUNT_KEY = "pUKqADWFqpP4TZtffssL";
    ...
    private void initializeFramework() {
       ...
       // QBSettings.getInstance().setStoringMechanism(StoringMechanism.UNSECURED);
